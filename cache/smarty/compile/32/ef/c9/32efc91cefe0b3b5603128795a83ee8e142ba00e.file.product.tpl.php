<?php /* Smarty version Smarty-3.1.19, created on 2018-11-25 18:28:45
         compiled from "/homepages/36/d725412653/htdocs/store/themes/default-bootstrap/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19059809295bfad96cd32830-07576072%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '32efc91cefe0b3b5603128795a83ee8e142ba00e' => 
    array (
      0 => '/homepages/36/d725412653/htdocs/store/themes/default-bootstrap/product.tpl',
      1 => 1543166924,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19059809295bfad96cd32830-07576072',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5bfad96d5a4b51_46437991',
  'variables' => 
  array (
    'errors' => 0,
...
<?php if ($_valid && !is_callable('content_5bfad96d5a4b51_46437991')) {function content_5bfad96d5a4b51_46437991($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/homepages/36/d725412653/htdocs/store/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_modifier_date_format')) include '/homepages/36/d725412653/htdocs/store/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_cycle')) include '/homepages/36/d725412653/htdocs/store/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/homepages/36/d725412653/htdocs/store/tools/smarty/plugins/function.counter.php';
?>
...
<!--
			<p id="product_reference"<?php if (empty($_smarty_tpl->tpl_vars['product']->value->reference)||!$_smarty_tpl->tpl_vars['product']->value->reference) {?> <?php }?>>
...
?>
															<li class="square-size">
																<input id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_attribute']->value, ENT_QUOTES, 'UTF-8', true);?>
" type="radio" class="attribute_radio" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['groupName']->value, ENT_QUOTES, 'UTF-8', true);?>
...
" <?php if (($_smarty_tpl->tpl_vars['group']->value['default']==$_smarty_tpl->tpl_vars['id_attribute']->value)) {?> checked="checked"<?php }?> />
																<label class="label-size" for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_attribute']->value, ENT_QUOTES, 'UTF-8', true);?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['group_attribute']->value, ENT_QUOTES, 'UTF-8', true);?>
</label>
															</li>
														<?php } ?>
...
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Add to shopping bag'),$_smarty_tpl);?>
<?php }?></span>
								</button>
							</p>
						</div>
...
" data-id="resetImages">
			...
			<!-- Nav product next or prev -->
				<div class="product-navigation clearfix">
					<?php if ($_smarty_tpl->tpl_vars['prev_product']->value) {?>
						<a title="<?php echo $_smarty_tpl->tpl_vars['prev_product']->value['name'];?>
" class="btn btn-default" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getProductLink($_smarty_tpl->tpl_vars['prev_product']->value['id_product'],$_smarty_tpl->tpl_vars['prev_product']->value['link_rewrite']);?>
"><span><i class="icon-chevron-left"></i> <?php echo smartyTranslate(array('s'=>'Previous Product'),$_smarty_tpl);?>
</span></a>
					<?php }?>
					<?php if ($_smarty_tpl->tpl_vars['next_product']->value) {?>
						<a title="<?php echo $_smarty_tpl->tpl_vars['next_product']->value['name'];?>
" class="btn btn-default" style="float:right"href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getProductLink($_smarty_tpl->tpl_vars['next_product']->value['id_product'],$_smarty_tpl->tpl_vars['next_product']->value['link_rewrite']);?>
"><span><?php echo smartyTranslate(array('s'=>'Next Product'),$_smarty_tpl);?>
